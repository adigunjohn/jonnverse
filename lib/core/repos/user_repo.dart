...
class UserRepo{
  ...
  Future<void> blockOrUnblockUser({required User value}) async {
    try{
      await _firebaseService.blockOrUnblockUser(value);
    }catch(e){
      log('${AppStrings.userRepoLog}failed to unblock user ${value.blockedUsers} : $e');
